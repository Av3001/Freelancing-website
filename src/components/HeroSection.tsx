  ...
  return (
    ...
    >
      ...
      <div className="p-4 relative z-10 w-full text-center">
            ...
            Unlock your potential and join our thriving community of freelancers.
            Whether you are a seasoned professional or just starting your freelance journey, our platform connects you with clients seeking your unique skills.
            Take control of your work, set your own hours, and build your career on your terms.
            </p>
            <div className="mt-4">
                <Link href={"/services"}>
